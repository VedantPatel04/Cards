...
# A credit-card statement is kilobytes so anything larger may be an attack - rejected
...
def upload_transactions(request):
    ...
    # Scoped to request.user: a valid id belonging to someone else must look exactly like an id that does not exist.
    ...
    try:
        ...
        # a bad file not a bad server: normalize_csv rejected the shape.
